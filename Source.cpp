...
//reference : programming-study-notes.blogspot.tw/2014/03/uva-200-rare-order.html
int main(){
	bool matrix[26][26] = { { 0 } };
	int list[26] , nodes = 0;
	...
	//==============================================================================================
	cin >> previous;//If you want to put data of "cin" to a string variable,you need to include <string> libary first~
